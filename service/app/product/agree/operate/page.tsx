export default function UsePage() {
  return (
    <div className="w-full max-w-[1120px] mx-auto flex flex-col px-16pxr md:px-0 md:mt-35pxr gap-28pxr">
      <div>
        <h1 className="text-30pxr font-bold mb-15pxr">운영정책</h1>
        <p>
      ...
      <div>
        <h2 className="text-18pxr font-bold mb-12pxr">1. 서비스 이용 가이드</h2>
        <p>
      ...
      <div>
        <h2 className="text-18pxr font-bold mb-12pxr">3. 환불에 대해</h2>
        <p>
        ...
        <p>④이벤트로 얻은 코인을 환불 신청</p>
        <p>이벤트 등 무상으로 지급된 코인은 환불이 불가합니다.</p>
      </div>
      <div>
        <h2 className="text-18pxr font-bold mb-12pxr">
          4. 후원 및 이용에 대해
      ...
      <div>
        <h2 className="text-18pxr font-bold mb-12pxr">5. 환전에 대해</h2>
        <p>
        ...
        <p>단, 당사의 운영정책에 따라 이후 일부 변동이 있을 수 있습니다.</p>
        <p>자세한 내용은 [이용약관]을 참고해 주세요.</p>
      </div>
      <div>
        <h2 className="text-18pxr font-bold mb-12pxr">
