...
CHECKS_DEEP=(disk memory containers http_health actions batch_recent journal_errors backend_process nginx_errors cpu_load network mysql_status ssl_cert websochat ai_pipeline_batches)
