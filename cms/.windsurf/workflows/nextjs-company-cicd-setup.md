    ...
    develop:
      ...
      - step:
          ...
          script:
            ...
            - curl --location "https://slack.aiaracorp.com/api/v1/deploy" --header "Content-Type:application/json" --data '{"name":"CCLIME","code":"KFMOA","message":"CCLIME_ADMIN 배포가 완료되었습니다."}'
```
