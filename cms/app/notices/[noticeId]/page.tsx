"use client";
import { useEditNotice, useGetNoticeDetail } from "@/api/notice";
...
export default function Page() {
  ...
  const { data, isLoading, isFetching } = useGetNoticeDetail(noticeId || "");
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          ...
          <Table>
            <TableBody>
              ...
              {attachment || data?.data?.file_path ? (
                <TableRow>
                  <TableCell colSpan={2}>
