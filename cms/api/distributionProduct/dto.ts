...
export interface IEpisodeApplyItem {
  apply_id: number;
  episode_id: number;
  status_code: EpisodeApplyStatusCode;
  req_user_id: number;
  req_date: string;
...
export interface IGetEpisodeApplyListParams {
  status?: "all" | EpisodeApplyStatusCode;
  page?: number;
  count_per_page?: number;
}

export interface IGetEpisodeApplyListResponse {
  total_count: number;
  page: number;
  count_per_page: number;
  results: IEpisodeApplyItem[];
}

export interface IProcessEpisodeApplyResponse {
  result: boolean;
  episodeId: number;
}
