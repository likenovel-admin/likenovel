...
export interface IMainCharacterSlotCharacter {
  scopeKey: string;
  displayName: string;
  aliases: string[];
}
...
export interface ISearchMainCharacterSlotProductParams {
  search_word?: string;
  limit?: number;
}
...
export interface IGetCharacterRosterParams {
  product_id: number;
}

export interface IGetCharacterRosterResponse {
  data: IMainCharacterSlotCharacter[];
}
