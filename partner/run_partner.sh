...
# -----------------------------------------------------------------------------
if [ -f "/home/ln-admin/likenovel/partner/.env.production.prod" ]; then
  echo "[run_partner] applying .env.production.prod -> .env.production"
  cp -f "/home/ln-admin/likenovel/partner/.env.production.prod" "/home/ln-admin/likenovel/partner/.env.production"
fi
